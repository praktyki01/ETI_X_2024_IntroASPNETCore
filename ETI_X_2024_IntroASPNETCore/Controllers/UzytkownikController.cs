...
namespace ETI_X_2024_IntroASPNETCore.Controllers
{
    public class UzytkownikController : Controller
    {
        ...
        public UzytkownikController(ETI_X_2024_IntroASPNETCoreContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("UzytkownikId,Imie,Nazwisko,Wzrost,Plec,Email,Password")] Uzytkownik uzytkownik)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("UzytkownikId,Imie,Nazwisko,Wzrost,Plec,Email,Password")] Uzytkownik uzytkownik)
        {
