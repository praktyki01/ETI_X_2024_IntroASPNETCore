...
namespace ETI_X_2024_IntroASPNETCore.Controllers
{
    public class ModelController : Controller
    {
        ...
        public ModelController(ETI_X_2024_IntroASPNETCoreContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("ModelId,Nazwa")] Model model)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ModelId,Nazwa")] Model model)
        {
            if (id != model.ModelId)
            {
                return NotFound();
